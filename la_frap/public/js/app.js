    ...
    for(var i=1; i<211; i++){
        ...
        if(i<22){
            if(i<8){
                ...
                elem.setAttribute("style","display: flex ; flex-direction: row; flex-wrap: wrap;position: absolute;top: 30%;height: 17%;width: 14.3%;align-items: center; justify-content: center;")
